 ...
 */
final class CalendarSystemsPoorMansJaliliCalendar extends CalendarSystemsPartialImplementation implements CalendarSystemsInterface {
  ...
  public function copy() {
    return new CalendarSystemsPoorMansJaliliCalendar($this->timezone, $this->langCode);
  }
  ...
  public function parse($date, $format) {
    ...
    if (strlen($dt['year']) == 2) {
      $now = new CalendarSystemsPoorMansJaliliCalendar($this->timezone, 'en');
