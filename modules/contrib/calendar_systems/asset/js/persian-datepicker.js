    ...
    /******/([
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        var Helper = {
          ...
          /**
           * @desc show debug messages if window.persianDatepickerDebug set as
           *   true
           * @param elem
           * @param input
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        var API = function () {
          ...
          _createClass(API, [{
            ...
            /**
             * @description set selected date of datepicker accept unix
             *   timestamp
             * @param unix
             * @example var pd = $('.selector').persianDatepicker();
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        var Config = {
          ...
          /**
           * @description set default calendar mode of datepicker, available
           *   options: 'persian', 'gregorian'
           * @default 'persian'
           * @type string
           * @since 1.0.0
           */
          ...
          'calendar': {
            ...
            'persian': {
              ...
              /**
               * @description set locale of Persian calendar available options:
               *   'fa', 'en'
               * @default 'fa'
               * @type string
               * @since 1.0.0
              ...
              /**
               * @description if set true, small date hint of this calendar
               *   will be shown on another calendar
               * @type boolean
               * @default false
               * @since 1.0.0
               */
              ...
              /**
               * @description Persian calendar leap year calculation mode,
               *   available options: 'algorithmic', 'astronomical'
               * @type string
            ...
            'gregorian': {
              ...
              /**
               * @description set locale of Gregorian calendar available
               *   options: 'fa', 'en'
               * @default 'en'
               * @type string
               * @since 1.0.0
          ...
          /**
           * @description if set true make enable responsive view on mobile
           *   devices
           * @type boolean
           * @since 1.0.0
           * @default true
           ...
           *   use data-date property when you want set inline datepicker
           *   initial value
           * @type boolean
           * @default true
           */
          ...
          /**
           * @description Initial value calendar type, accept: 'persian',
           *   'gregorian'
           * @type boolean
           * @default true
           */
          ...
          /**
           * @description from v1.0.0 this options is deprecated, use
           *   calendar.persian.locale instead
           * @deprecated
           * @type boolean
           * @default true
           */
          ...
          /**
           * @description the date format, combination of d, dd, m, mm, yy,
           *   yyy.
          ...
          /**
           * @description An input element that is to be updated with the
           *   selected date from the datepicker. Use the altFormat option to
           *   change the format of the date within this field. Leave as blank
           *   for no alternate field. acceptable value: :
          ...
          /**
           * @description Set min date on datepicker, prevent user select date
           *   before given unix time
           * @property minDate
           * @type Date
           * @default null
           */
          ...
          /**
           * @description Set max date on datepicker, prevent user select date
           *   after given unix time
           * @property maxDate
           * @type Date
           * @default null
           */
          ...
          'navigator': {
            ...
            'scroll': {
              ...
              /**
               * @description if you want make disable scroll navigation set
               *   this option false
               * @type boolean
               * @default true
               */
          ...
          /**
           * @description  if true date select just by click on day in month
           *   grid, and when user select month or year selected date doesnt
           *   change
          ...
          'timePicker': {
            ...
            /**
             * @description The amount that increases or decreases by pressing
             *   the button
             * @type number
             */
            'step': 1,
            ...
            'hour': {
              ...
              /**
               * @description The amount that increases or decreases hour, by
               *   pressing the button. overwrite by timepicker.step
               * @type boolean
               */
              'step': null
            },
            ...
            'minute': {
              ...
              /**
               * @description The amount that increases or decreases minute, by
               *   pressing the button. overwrite by timepicker.step
            ...
            'second': {
              ...
              /**
               * @description The amount that increases or decreases second, by
               *   pressing the button. overwrite by timepicker.step
               * @type boolean
               */
              'step': null
            ...
            'meridian': {
              ...
              /**
               * @description if you set this as false, datepicker timepicker
               *   system moved to 24-hour system
               * @type boolean
               */
              'enabled': false
            }
          ...
          /**
           * @description A function that takes current datepicker instance. It
          ...
          /**
           * @description A function that takes current datepicker instance. It
           *   is called just before the datepicker Hide.
           * @event
           */
          ...
          /**
           * @description by default datepicker have a template string, and you
           *   can overwrite it simply by replace string in config.
           * @type string
           * @example
           * <div id="plotId" class="datepicker-plot-area
          ...
          /**
           * @description if true datepicker update self by user inputted date
           *   string, accept 'yyyy/mm/dd'
           * @example '1396/10/2', ''
           * @type {boolean}
           * @default false
           */
          ...
          /**
           * @description waite time for last user key-down event, accept
           *   millisecond
           * @type {number}
           * @default 800
           */
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        /**
         * Do every thing about input element like get default value, set new
         * value, set alt field input and etc.
         */
        ...
        var Input = function () {
          ...
          _createClass(Input, [{
            ...
            value: function observe() {
              ...
              //             let newPersainDate =
              // this.model.PersianDate.date(newDate);
      ...
      /***/ (function (module, exports, __webpack_require__) {
         ...
         * also this object notify other object to update self or update view
         * or etc.
         */
        var State = function () {
          ...
          function State(model) {
             ...
             * @type {{start: {year: number, month: number, date: number, hour:
             *   number, minute: number, second: number, unixDate: number},
             *   end: {year: number, month: number, date: number, hour: number,
             *   minute: number, second: number, unixDate: number}}}
             */
            this.filterDate = {
              start: {
                year: 0,
             ...
             * @type {{year: number, month: number, date: number, hour: number,
             *   minute: number, second: number, unixDate: number, dateObject:
             *   null, meridian: string}}
             */
            this.view = {
              year: 0,
              month: 0,
          ...
          _createClass(State, [{
             ...
             * @param {String} key - accept date, month, year, hour, minute,
             *   second
             * @param {Number} value
             * @public
             * @return {State}
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        var View = function () {
          ...
          _createClass(View, [{
            ...
            /**
             * @desc set datepicker container element based on <input/> element
             *   position
             */
            ...
            value: function _getDayViewModel() {
              ...
              //log('if you see this many time your code has performance
              // issue');
            ...
            /**
             * @private
             * @return {{enabled: boolean, hour: {title, enabled: boolean},
             *   minute: {title, enabled: boolean}, second: {title, enabled:
             *   boolean}, meridian: {title: (meridian|{title,
             *   enabled}|ClassDatepicker.ClassConfig.timePicker.meridian|{enabled}|string|string),
             *   enabled: boolean}}}
             */
            ...
            /**
             * @desc render times area, prevent performance issue with scroll
             *   and time section
             */
            ...
            browser: function normaliseBrowser() {
              ...
              if (!('onwheel' in document || document.documentMode >= 9)) {
                Hamster.SUPPORT = document.onmousewheel !== undefined ?
                  'mousewheel' : // webkit and IE < 9 support at least
                                 // "mousewheel"
                  'DOMMouseScroll'; // assume remaining browsers are older
                                    // Firefox
              }
 ...
 */
        ...
        (function defineMustache(global, factory) {
          ...
          /**
           * Safe way of detecting whether or not the given thing is a
           * primitive and whether it has the given property
           */
          ...
          /**
           * Breaks up the given `template` string into a tree of tokens. If
           * the `tags` argument is given here it must be an array with two
           * string values: the opening and closing tags used in the template
           * (e.g. [ "<%", "%>" ]). Of course, the default is to use mustaches
           * (i.e. mustache.tags).
           *
           * A token is an array with at least 4 elements. The first element is
           * the mustache symbol that was used inside the tag, e.g. "#" or "&".
           * If the tag did not contain a symbol (i.e. {{myValue}}) this
           * element is "name". For all text that appears outside a symbol this
           * element is "text".
           *
           * The second element of a token is its "value". For mustache tags
           * this is whatever else was inside the tag besides the opening
           * symbol. For text tokens this is the text itself.
           *
           * The third and fourth elements of the token are the start and end
           * indices, respectively, of the token in the original template.
           *
           * Tokens that are the root node of a subtree contain two more
           * elements: 1) an array of tokens in the subtree and 2) the index in
           * the original template at which the closing tag for that section
           * begins.
           */
          function parseTemplate(template, tags) {
            ...
            var spaces = [];       // Indices of whitespace tokens on the
                                   // current line
            var hasTag = false;    // Is there a {{tag}} on the current line?
            var nonSpace = false;  // Is there a non-space char on the current
                                   // line?
           ...
           * `tokens` array to a single token.
           */
           ...
           * where tokens that represent a section have two additional items:
           * 1) an array of all tokens that appear in that section and 2) the
           * index in the original template that represents the end of that
           * section.
           */
           ...
           * position. Returns the matched text if it can match, the empty
           * string otherwise.
           */
           ...
           * Returns the skipped string, which is the entire tail if no match
           * can be made.
           */
           ...
           * up the context hierarchy if the value is absent in this context's
           * view.
           */
          Context.prototype.lookup = function lookup(name) {
            ...
            if (cache.hasOwnProperty(name)) {
              ...
              var context = this, intermediateValue, names, index,
                lookupHit = false;
              ...
              while (context) {
                if (name.indexOf('.') > 0) {
                  ...
                  /**
                   * Using the dot notion path in `name`, we descend through
                   * the
                   * nested objects.
                   *
                   * To be certain that the lookup has been successful, we have
                   * to check if the last object in the path actually has the
                   * property we are looking for. We store the result in
                   * `lookupHit`.
                   *
                   * This is specially necessary for when the value has been
                   * set to
                   * `undefined` and we want to avoid looking up parent
                   * contexts.
                   *
                   * In the case where dot notation is used, we consider the
                   * lookup to be successful even if the last "object" in the
                   * path is not actually an object but a primitive (e.g., a
                   * string, or an integer), because it is sometimes useful to
                   * access a property of an autoboxed primitive, such as the
                   * length of a string.
                   **/
                  ...
                  /**
                   * Only checking against `hasProperty`, which always returns
                   * `false` if
                   * `context.view` is not an object. Deliberately omitting the
                   * check against `primitiveHasOwnProperty` if dot notation is
                   * not used.
                   *
                   ...
                   * ```
                   *
                   * If we were to check also against
                   * `primitiveHasOwnProperty`, as we do in the dot notation
                   * case, then render call would return:
                   *
          ...
          /**
           * Parses and caches the given `template` according to the given
           * `tags` or
           * `mustache.tags` if `tags` is omitted,  and returns the array of
           * tokens that is generated from the parse.
           */
           ...
           * the given `view`.
           *
           * The optional `partials` argument may be an object that contains
           * the
           * names and templates of partials that are used in the template. It
           * may also be a function that is used to load partial templates on
           * the fly that takes a single argument: the name of the partial.
           *
           * If the optional `tags` argument is given here it must be an array
           * with two string values: the opening and closing tags used in the
           * template (e.g.
           ...
           *
           * Note: The `originalTemplate` is only ever used to extract the
           * portion of the original template that was contained in a
           * higher-order section. If the template doesn't use higher-order
           * sections, this argument may be omitted.
           */
          ...
          /**
           * Parses and caches the given template in the default writer and
           * returns the array of tokens it contains. Doing this ahead of time
           * avoids the need to parse templates on the fly as they are
           * rendered.
           */
           ...
           * the default writer. If the optional `tags` argument is given here
           * it must be an array with two string values: the opening and
           * closing tags used in the template (e.g. [ "<%", "%>" ]). The
           * default is to mustache.tags.
           */
