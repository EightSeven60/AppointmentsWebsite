      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        var PersianDateClass = function () {
          ...
          _createClass(PersianDateClass, [{
            ...
            /**
             * @since 1.0.0
             * @description Helper method that return date range name like week
             *   days name, month names, month days names (specially in persian
             *   calendar).
             * @static
             * @return {*}
             */
...
// Start algorithm class
        ...
        var Algorithms = function () {
          function Algorithms(parent) {
            ...
            this.J0000 = 1721424.5; // Julian date of Gregorian epoch:
                                    // 0000-01-01
          ...
          /**
           * @desc LEAP_GREGORIAN  --  Is a given year in the Gregorian
          ...
          _createClass(Algorithms, [{
            ...
            //         which the year -1 (1 B.C.E) is followed by year 1 (1
            // C.E.).  */  if (year < 1) { year--; }  return [year, month,
            // day]; }


            /**
             * @desc TEHRAN_EQUINOX  --  Determine Julian day and fraction of
             *   the
            ...
            /**
             * @desc TEHRAN_EQUINOX_JD  --  Calculate Julian day during which
             *   the
            ...
            /**
             * @desc Is a given year a leap year in the Persian astronomical
             *   calendar ?
             * @param {*} year
             */
             ...
             * also nasa use this algorithm
             *   https://eclipse.gsfc.nasa.gov/SKYCAL/algorithm.js search for
             *   'getLastDayOfPersianMonth' and you can find it
             * @param {*} year
             *
             */
            ...
            /**
             * @desc updateFromGregorian  --  Update all calendars from
             *   Gregorian.
            ...
            value: function updateFromGregorian() {
              ...
              // ---------------------------------------------------------------------------
              // julcal = this.jd_to_julian(j);  this.State.juliancalendar.year
              // = julcal[0]; this.State.juliancalendar.month = julcal[1] - 1;
              // this.State.juliancalendar.day = julcal[2];
              // this.State.juliancalendar.leap =
              // this.NormLeap[this.leap_julian(julcal[0]) ? 1 : 0];
              weekday = this.ASTRO.jwday(j);
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        var ASTRO = function () {
          function ASTRO() {
            ...
            this.JulianMillennium = this.JulianCentury * 10; // Days in Julian
                                                             // millennium
            ...
            /**
             * @desc Table of observed Delta T values at the beginning of even
             *   numbered years from 1620 through 2002.
             * @type Array
             */
          ...
          _createClass(ASTRO, [{
            ...
            value: function sunpos(jd) {
              ...
              return [//  Angular quantities are expressed in decimal degrees
                ...
                Lambda, //  [7] Sun's apparent longitude at true equinox of the
                        // date
            ...
            /**
             * @desc Compute equation of time for a given moment. Returns the
             *   equation of time as a fraction of a day.
             * @param jd
             * @return {number|*}
             */
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        var Container = function Container() {
          ...
          /**
           *
           * @type {{year: number, month: number, day: number, hour: number,
           *   minute: number, second: number, millisecond: number, weekday:
           *   number, unix: number, leap: number}}
           */
          this.gregorian = {
            year: 0,
            month: 0,
          ...
          /**
           *
           * @type {{year: number, month: number, day: number, leap: number,
           *   weekday: number}}
           */
          this.juliancalendar = {
            year: 0,
