 ...
 * @endcode
 */
$settings['hash_salt'] = 'vKlzpbLK7E06P7a_aAFm-1WGyntwaoeW17CpFISW8UY6hpZiRrRp1VvU1wF8thQ9VnNDONgpWg';
...
$databases['default']['default'] = array (
  'database' => 'doc_appointments_website_db',
  'username' => 'root',
  'password' => '',
  'prefix' => '',
  'host' => 'localhost',
...
$settings['config_sync_directory'] = 'sites/default/files/config_WhVeapZgVeEiFbyvh3s2EDynCZX5fhMcEhjA9_8o-wR0bVMK1CXniDukT6DI54TFR3kRQvhMvA/sync';
$settings['trusted_host_patterns'] = [
   '^www\.mydocsite\.net$',
   '^localhost$',
 ];
